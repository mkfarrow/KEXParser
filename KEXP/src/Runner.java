...
public class Runner {	
	...
	/**
	 * The urls that have been visited persist in a text file. Read in those urls
	...
	/**
	 * Returns a list of all the URLs that have playlist data on kexp.org/playlist
	 * 
	...
	private Runner() { throw new UnsupportedOperationException(); }
}