...
public class KEXParser {
    ...
    public KEXParser(PrintStream errors) {
        this.errors = errors;
    }
    ...
    public List<Play> parsePlays(String url) {
        ...
        for (Element item : playlistItems.children()) {
            ...
            Element releaseMetadata = item
                    .getElementsByClass("ReleaseMetadata").first();
    ...
    /**
     * Turns the URL and the airDate (which is a time of day like 3:47 PM or
     * something) into a SQL DATETIME String.
     * 
     * @param url
     *            the url (which has date information e.g.
     *            kexp.org/playlist/2012/04/12/4am)
     * @param airDate
     *            the html element containing the time of the play
