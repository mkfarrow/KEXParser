...
/**
 * Dumb little script to convert from the JSON version of the output to the
 * tab-separated version. This only exists because I ran the Runner/Crawler with
 * the JSON output format initially and doing this conversion is much faster
 * than re-running the crawlers with a new output form. Having the JSON data is
 * nice too because it is more flexible and share-able.
 */
public class JsonToTabs {
    ...
    /**
     * assumes that this is not a valid JSON object insofar as the " character
     * is not escaped as \"
     * 
     * @param json
